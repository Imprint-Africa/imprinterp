...
import { faDiceD6, faChartLine, faNetworkWired, faProjectDiagram, faUsers, faEdit, faShoppingCart,
  faDollarSign, faCloudDownloadAlt } from '@fortawesome/free-solid-svg-icons';
...
ngOnInit() {
                ...
                oppData => {
                  ...
                  this.customService.getAllServices().subscribe(
                    servicesData => {
                      ...
                      this.set_services_vs_targetR_and_revenue();
  ...
  this.clientService.listClients().subscribe(
        ...
        error => console.log('Error listing Clients')
      );
...
let TotalRevenue = this.Opportunitys.reduce( (previous, current) => previous + current.revenue, 0);
...
// Predifined
set_services_vs_targetR_and_revenue() {
  this.settingData();
  ...
  this.chartDatasetValue = [this.datasetTargetRevenue , this.datasetRevenue, this.datasetOppNumberForService ];
  this.chartFunction();
  this.definedDataSet = 1;

}
set_salesStages_vs_opportunities_and_revenue() {
  this.settingData();
  this.chartTypeValue = 'pie';
  this.backgroundColor = this.brandLight;
  this.displayY = false;
  this.displayX = true;
  this.stackedX = false;
  ...
  this.dataSetOpportunitysForSalesCat.backgroundColor = this.datasetOpportunityBgColorForSalesCat;
  this.chartDatasetValue = [this.dataSetOpportunityRevenueSalesCat, this.dataSetOpportunitysForSalesCat];
  this.chartFunction();
  this.definedDataSet = 2;
}
set_clients_vs_revenue() {
  this.settingData();
  this.chartTypeValue = 'polarArea';
  this.backgroundColor = this.brandSuccess;
  this.displayY = false;
  this.displayX = true;
  this.stackedX = false;
  this.stackedY = false;
  ...
  this.legendColor = this.brandDark;
  this.chartLablesValue = this.labelClients;
  this.dataSetOpportunityRevenueForClients.backgroundColor = this.datasetOpportunityBgColorForClients;
  this.dataSetOpportunityNumberForClients.backgroundColor = this.datasetOpportunityBgColorForClients;
  this.chartDatasetValue = [this.dataSetOpportunityRevenueForClients, this.dataSetOpportunityNumberForClients];
  this.chartFunction();
...
set_opportunities_vs__revenue() {
  ...
  this.legendColor = this.brandDark;
  this.chartLablesValue = this.labelOpportunitys;
  this.dataSetOpportunityRevenueForOpps.backgroundColor = this.dataSetOpportunityRevenueForOppsBgColors;
...
set_salesUser_vs_opportunities_and_revenue() {
  ...
  this.legendColor = this.brandDark;
  this.chartLablesValue = this.labelSalesUsers;
  this.dataSetOpportunityRevenueForSalesUser.backgroundColor = this.dataSetOpportunityBgColorForSalesUser;
  this.dataSetOpportunityNumberForSalesUser.backgroundColor = this.dataSetOpportunityBgColorForSalesUser;
  this.chartDatasetValue = [this.dataSetOpportunityRevenueForSalesUser, this.dataSetOpportunityNumberForSalesUser];
  this.chartFunction();
